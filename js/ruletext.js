...
export const RULES = [
  {
    ...
    title: 'Würfeln',
    topics: [
      { title: 'Der Grundwurf', html: `
        <p><b>Basiswürfel</b> = Attribut + Skill, angepasst um Schwierigkeit, Ausrüstung und Hilfe. Dazu <b>Stresswürfel</b> in Höhe des Stress Levels.</p>
        <ul>
          <li>Jede <b>6</b> ist ein Erfolg, auch auf Stresswürfeln.</li>
          <li>Modifikatoren ändern nur Basiswürfel, nie Stresswürfel. Minimum: 1 Basiswürfel.</li>
          <li>Eine <b>1 auf einem Stresswürfel</b> löst eine Stress Response aus.</li>
          <li>Ohne Skill: nur das Attribut würfeln (plus Stresswürfel).</li>
          <li>Das Attribut darf getauscht werden, wenn es passt (z. B. Strength + Manipulation zum Einschüchtern).</li>
        </ul>` },
      { title: 'Helfen', html: `
        <p>Bis zu 3 Helfer, je <b>+1 Würfel</b> (max. +3). Sie müssen die Aktion konkret unterstützen können. Im Kampf kostet Helfen die volle Aktion.</p>` },
      { title: 'Pushen', html: `
        <p>Einmal pro Wurf: <b>Stress Level +1</b> (Jumpy: +2), dann alle Würfel ohne 6 neu werfen. Der neue Stresswürfel kommt dazu, die bisherigen 6er bleiben.</p>
        <ul>
          <li><b>Kein Push</b>, wenn im ersten Wurf schon eine 1 auf einem Stresswürfel lag.</li>
          <li>Kein Push, wenn Deflated.</li>
          <li>NPCs, Synthetics und Xenomorphs pushen nie.</li>
        </ul>` },
      { title: 'Extra-Erfolge', html: `
      ...
      { title: 'Schwierigkeit', html: `
        <p>Es gibt <b>keine benannten Schwierigkeitsstufen</b> mehr. Regelbuch und Abenteuer geben situative Modifikatoren vor (z. B. Fernkampf-Tabelle), sonst legt die SL +/− Würfel fest.</p>` },
      { title: 'Passive Würfe', html: `
        <p>Die SL kann Würfe verlangen, von denen du nichts weißt (meist Observation im Stealth). Sie können nicht gepusht werden und lösen keine Stress Response aus. Stresswürfel kommen trotzdem dazu.</p>` },
    ],
  },
  {
    key: 'charakter',
  ...
  },
  {
    ...
    title: 'Stress',
    topics: [
      { title: 'Stress Level steigt …', html: `
        <ul>
          ...
          <li>+1 wenn du durch Fatigue Schaden nimmst, bei Gnadenstoß oder Angriff durch die eigene Crew, wenn ein getarnter Synthetic entdeckt wird, sowie laut Szenario/SL</li>
        </ul>` },
      { title: 'Stress Response: W6 + Stress − Resolve', html: `
        <p>Ausgelöst durch <b>eine 1 auf einem Stresswürfel</b>. Responses bleiben, bis Stress abgebaut wird. Hast du sie schon: stattdessen Stress +1.</p>
        ${table([
          ['≤0', '<b>Keeping Cool</b>: keine Wirkung.'],
          ['1', '<b>Jumpy</b>: Pushen kostet +2 Stress statt +1.', 'r1'],
          ['2', '<b>Tunnel Vision</b>: −2 Würfel auf alle Wits-Würfe.', 'r1'],
          ['3', '<b>Aggravated</b>: −2 Würfel auf alle Empathy-Würfe.', 'r1'],
          ['4', '<b>Shakes</b>: −2 Würfel auf alle Agility-Würfe.', 'r1'],
          ['5', '<b>Frantic</b>: −2 Würfel auf alle Strength-Würfe.', 'r2'],
  ...
  },
  {
    ...
    title: 'Panik',
    topics: [
      { title: 'Wann wird auf Panik gewürfelt?', html: `
        <ul>
          ...
          <li>Laut Abenteuer/SL bei einem wirklich schlimmen Moment.</li>
        </ul>
        <p>Eine 1 auf dem Stresswürfel löst <b>keine</b> Panik aus. Broken-Charaktere würfeln nicht auf Panik.</p>` },
      { title: 'Panic Response: W6 + Stress − Resolve', html: table([
        ['≤0', '<b>Keeping Cool</b>: keine Wirkung.'],
        ['1', '<b>Spooked</b>: Stress +1.', 'r1'],
        ['2', '<b>Noisy</b>: Gegner in der Nähe bemerken dich automatisch.', 'r1'],
        ['3', '<b>Twitchy</b>: sofort Supply Roll für Luft, Munition oder Energie (SL wählt).', 'r1'],
      ...
      { title: 'Panik endet & Mehrfach-Panik', html: `
    ...
    topics: [
      ...
      { title: 'Stealth-Ablauf', html: `
        <ol>
          ...
          <li>NPCs ziehen eine Zone auf der verdeckten SL-Karte, Xenomorphs eine Zone pro Punkt Speed. Sichtlinie: Wurf wie oben.</li>
      ...
      { title: 'Hinterhalt', html: `
        <p>Wer aus dem Hinterhalt angreift, handelt in der ersten Runde zuerst und bekommt <b>+2 Würfel</b> auf den ersten Angriff. Nahkampf gegen ahnungslose Ziele: +2 Würfel.</p>` },
    ],
  },
  {
    key: 'kampf',
    title: 'Kampf',
    topics: [
      { title: 'Runde & Initiative', html: `
        <p>Initiativekarten 1–10, niedrigste zuerst; jede Runde neu gezogen (optional nur in Runde 1). NSC-Gruppen können eine gemeinsame Karte ziehen.</p>
      ...
      { title: 'Nahkampf', html: `
        ...
        <p>Schusswaffe im Nahkampf: Close Combat, meist −2 Würfel.</p>` },
      { title: 'Fernkampf', html: `${table([
        ...
        <p>Über die Maximalreichweite kein Schuss. <b>Ausweichen</b>: Quick Action (Interrupt), nur wenn du den Angreifer bemerkt hast. <b>Dunkelheit</b>: −2 Würfel auf Observation (nicht auf den Angriff); eine Taschenlampe hebt das auf.</p>` },
      { title: 'Deckung', html: `
        <p><b>Teilweise</b> (Quick Action): Angriffe gegen dich −2 Würfel, du kannst weiter ausweichen.</p>
        <p><b>Volle</b> (Full Action): bricht die Sichtlinie, Angriffe gegen dich −3 Würfel, kein Ausweichen. Trifft der Schuss, sinkt der Schaden zusätzlich um den Armor-Wert der Barriere. <b>Breach Limit</b>: ist die Barriere stärker als der Basisschaden, kommt nichts durch.</p>
        <p><b>Friendly Fire</b>: Ein verfehlter Schuss kann jemanden treffen, der Adjacent zum Ziel steht.</p>` },
      { title: 'Vollautomatik', html: `
      ...
      { title: 'Munition', html: `
        <p>Munition läuft als <b>Supply-Rating</b>. Nach jedem Angriffswurf ein Ammo-Supply-Roll, außer du nutzt einen Extra-Erfolg zum Munitionsparen.</p>
      ...
      { title: 'Rüstung', html: `
        ...
        <ul>
          ...
          <li><b>Schwachstelle</b> (−2 Würfel): bei Treffer Rüstung zusätzlich −1.</li>
    ...
    topics: [
      ...
      { title: 'Critical Injuries & Death Roll', html: `
        <ul>
          ...
          <li>Death Roll = Stamina-Wurf, keine Aktion, kein Push, keine Stresswürfel. Misslungen: tot. Gelungen: Zeitlimit beginnt neu.</li>
          <li>Limit „Round“: Death Roll jede Runde direkt nach deinem Zug.</li>
          <li><b>Erste Hilfe</b> an tödlicher Verletzung: Erfolg stabilisiert. Misserfolg: Limit sinkt eine Stufe (Shift → Stretch → Round); war es schon Round, stirbst du. Selbstbehandlung mit −2 Würfeln.</li>
  ...
  {
    key: 'gefahren',
    title: 'Gefahren & Umwelt',
    topics: [
      { title: 'Säure (Acid Splash)', html: `
        <p>Nimmt ein Xenomorph Schaden (außer Feuer), spritzt Säure auf alle <b>Adjacent</b>. Basiswürfel = Acid-Splash-Wert + erlittener Schaden (max. seine Health). Schaden 1, +1 pro weiterer 6. Jeder erlittene Schadenspunkt frisst die Rüstung um 1 Stufe an.</p>
      ...
      { title: 'Explosionen', html: `
        <p><b>Explosive Waffen</b>: normaler Fernkampfangriff; bei Treffer nehmen alle anderen in der Zone denselben Schaden. Jeder darf einzeln ausweichen. Geschlossener Raum: +2 Würfel.</p>
        <p><b>Sprengladungen</b> haben eine <b>Blast Power</b>: Basisschaden = Blast Power ÷ 3 (aufgerundet). Ein Wurf mit Basiswürfeln = Blast Power gegen alle in der Zone; +1 Schaden je weiterer 6.</p>` },
      { title: 'Feuer', html: `
        ...
        <p><b>Ausbreitung</b> (W6 zu Rundenbeginn): 1–2 erlischt · 3–4 brennt weiter · 5–6 springt auf eine Nachbarzone über.</p>` },
      { title: 'Stürze', html: `
      ...
      { title: 'Vakuum & Luft', html: `
        <p>Luftvorrat: <b>Supply Roll</b> nach jedem Stretch im Anzug und nach Anstrengung. Würfel = aktueller Vorrat (max. 6), <b>jede 6 senkt ihn um eins</b>.</p>
        <p>Ungeschützt im Vakuum: Stress +1 pro Runde; vor jeder Handlung ein Survival-Wurf (−1 Würfel pro weiterem Wurf). Fehlschlag: sofort Broken, Death Roll jede Runde bis zur Flucht.</p>` },
      { title: 'Fatigue (Entbehrung)', html: `
        <ul>
          ...
          <li><b>Hitze/Kälte</b>: Intervall legt die SL fest.</li>
        </ul>
      ...
      { title: 'Strahlung', html: `
        <p>Rad-Punkte je nach Stufe: <b>Weak</b> 1/Shift, <b>Strong</b> 1/Stretch, <b>Extreme</b> 1/Runde. Jeder neue Rad-Punkt: Würfel = alle Rads, jede 6 = 1 Schaden. Im Hotspot keine Health-Erholung; danach 1 Rad/Shift Heilung.</p>` },
    ],
  },
  {
    key: 'wesen',
    title: 'NSCs, Synthetics & Xenomorphs',
    topics: [
      { title: 'NSCs', html: `
      ...
      { title: 'Synthetics', html: `
        <ul>
          ...
          <li>Bei 0 Health: W6 auf <b>Android Critical System Damage</b>.</li>
        </ul>
        ${table([
      ...
      { title: 'Xenomorphs', html: `
        <ul>
          ...
          <li><b>Signature Attack</b>: W6 auf der Tabelle der Kreatur.</li>
      ...
      { title: 'Xenomorph auf 0 Health (W6)', html: `${table([
        ['1', '<b>Rise Again</b>: scheinbar tot, im nächsten Zug +1 Health und steht wieder auf.', 'r1'],
        ['2', '<b>Wounded</b>: Speed −1, +1 Health; bei 1–3 auf W6 zu Zugbeginn flieht es.', 'r1'],
